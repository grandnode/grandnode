...
using Grand.Plugin.Shipping.Fedex.Domain;
using Grand.Plugin.Shipping.Fedex.RateServiceWebReference;
    ...
    public class FedexComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        private void SetDestination(RateRequest request, GetShippingOptionRequest getShippingOptionRequest)
        {
                ...
                country!=null)
            {
                ...
                if (IncludeStateProvinceCode(country.TwoLetterIsoCode))
                    request.RequestedShipment.Recipient.Address.StateOrProvinceCode = state.Abbreviation;
            }
            else
            {
            ...
            if(country!=null)
                request.RequestedShipment.Recipient.Address.CountryCode = country.TwoLetterIsoCode;
        }
        ...
        private void SetIndividualPackageLineItemsOneItemPerPackage(RateRequest request, GetShippingOptionRequest getShippingOptionRequest, string currencyCode)
        {
            ...
            foreach (var packageItem in items)
            {
                ...
                for (int j = 0; j < qty; j++)
                {
                    ...
                    request.RequestedShipment.RequestedPackageLineItems[i].InsuredValue = new Money(); // insured value
                    request.RequestedShipment.RequestedPackageLineItems[i].InsuredValue.Amount = product.Price;
                    request.RequestedShipment.RequestedPackageLineItems[i].InsuredValue.Currency = currencyCode;
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Grand.Plugin.Shipping.Fedex.Controllers" }, { "area", null } };
        }
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByDimensions", "Pack by dimensions");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage", "Pack by one item per package");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByVolume", "Pack by volume");
            ...
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter", "Business service center");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.DropBox", "Drop box");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.RegularPickup", "Regular pickup");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.RequestCourier", "Request courier");
            this.AddOrUpdatePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.Station", "Station");
        ...
        public override void Uninstall()
        {
            ...
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByDimensions");
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByOneItemPerPackage");
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.PackingType.PackByVolume");
            ...
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.BusinessServiceCenter");
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.DropBox");
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.RegularPickup");
            this.DeletePluginLocaleResource("Enums.Grand.Plugin.Shipping.Fedex.DropoffType.RequestCourier");
