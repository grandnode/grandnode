...
namespace Grand.Plugin.Widgets.Slider
{
    ...
    public class SliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task Install()
        {
            ...
            var pic1 = await _pictureService.InsertPicture(byte1, "image/jpeg", "banner_1", validateBinary: false, altAttribute: "First banner");
            var pic2 = await _pictureService.InsertPicture(byte2, "image/png", "banner_2", validateBinary: false, altAttribute: "Second banner");
