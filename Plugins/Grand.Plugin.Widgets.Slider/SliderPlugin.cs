    ...
    public class SliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task Install()
        {
            ...
            await _pictureSliderRepository.InsertAsync(new PictureSlider()
            {
                ...
                FullWidth = true,
                Published = true,
                PictureId = (await _pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "banner1.jpg"), "image/pjpeg", "banner_1")).Id,
            ...
            await _pictureSliderRepository.InsertAsync(new PictureSlider()
            {
                ...
                FullWidth = true,
                Published = true,
                PictureId = (await _pictureService.InsertPicture(File.ReadAllBytes(sampleImagesPath + "banner2.png"), "image/pjpeg", "banner_2")).Id,
