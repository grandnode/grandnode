    ...
    public class SliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task Install()
        {
            ...
            await _pictureSliderRepository.InsertAsync(new PictureSlider()
            {
                ...
                Published = true,
                PictureId = pic1.Id,
                Description = "<div class=\"row slideRow justify-content-start\"><div class=\"col-lg-6 d-flex flex-column justify-content-center align-items-center\"><div style=\"display: flex; flex-direction: column; align-items: center; justify-content: center;\"><div class=\"animated fadeInDown delay-1s\" style=\"color: #000000;font-size: 30px; font-weight: 300; line-height: 1; opacity: .9; padding: 15px 0 0 0;\">exclusive - modern - elegant</div><div class=\"animated zoomIn delay-0-5s\" style=\"color: #000000;font-size: 52px; font-weight: 500; line-height: 1; opacity: .9;\">Smart watches</div><div class=\"animated fadeInUp delay-1s\" style=\"color: #000000;font-size: 26px; font-weight: 500; opacity: .9; padding: 0 0 15px 0;\">Go to collection and see more...</div><a  class=\"btn btn-info animated fadeInUp delay-1-5s\" style=\"width: 100%; margin: 15px 0 0 0; background: #87C255; border-color: #87C255;\"> SHOP NOW </a></div></div></div>"
            });
