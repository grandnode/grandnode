...
using Grand.Plugin.DiscountRules.HasOneProduct.Models;
...
namespace Grand.Plugin.DiscountRules.HasOneProduct.Controllers
{
    [Area("Admin")]
    [AuthorizeAdmin]
    public class DiscountRulesHasOneProductController : BasePluginController
    {
        ...
        public IActionResult Configure(string discountId, string discountRequirementId)
        {
            ...
            return View("~/Plugins/DiscountRules.HasOneProduct/netcoreapp1.1/Views/DiscountRulesHasOneProduct/Configure.cshtml", model);
        }
        ...
        public IActionResult ProductAddPopup(string btnId, string productIdsInput)
        {
            ...
            return View("~/Plugins/DiscountRules.HasOneProduct/netcoreapp1.1/Views/DiscountRulesHasOneProduct/ProductAddPopup.cshtml", model);
        }
