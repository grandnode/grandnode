...
namespace Nop.Plugin.DiscountRules.HasAllProducts.Controllers
{
    ...
    public class DiscountRulesHasAllProductsController : BasePluginController
    {
        ...
        public ActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            //add a prefix
            ViewData.TemplateInfo.HtmlFieldPrefix = string.Format("DiscountRulesHasAllProducts{0}-{1}", discount.Id, discountRequirementId.HasValue ? discountRequirementId.Value.ToString() : "0");
