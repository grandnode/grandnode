...
namespace Grand.Plugin.Payments.PayPalDirect.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [GrandResourceDisplayName("Plugins.Payments.PayPalDirect.Fields.ApiAccountName")]
        public string ApiAccountName { get; set; }
        public bool ApiAccountName_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Plugins.Payments.PayPalDirect.Fields.ApiAccountPassword")]
        public string ApiAccountPassword { get; set; }
        public bool ApiAccountPassword_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Plugins.Payments.PayPalDirect.Fields.Signature")]
