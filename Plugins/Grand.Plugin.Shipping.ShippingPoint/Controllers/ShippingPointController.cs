...
namespace Grand.Plugin.Shipping.ShippingPoint.Controllers
{
    ...
    public class ShippingPointController : BaseShippingController
    {
        ...
        {
            return View("~/Plugins/Shipping.ShippingPoint/netcoreapp1.1/Views/Configure.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Plugins/Shipping.ShippingPoint/netcoreapp1.1/Views/Create.cshtml", PrepareShippingPointModel(model));
        }
        ...
        public ActionResult Create(string btnId, string formId, ShippingPointModel model)
        {
            ...
            return View("~/Plugins/Shipping.ShippingPoint/netcoreapp1.1/Views/Create.cshtml", model);
        }
        ...
        public ActionResult Edit(string id)
        {
            ...
            PrepareShippingPointModel(model);
            return View("~/Plugins/Shipping.ShippingPoint/netcoreapp1.1/Views/Edit.cshtml", model);
        }
