...
namespace Grand.Web.Areas.Admin.Services
{
    public partial class CustomerTagViewModelService : ICustomerTagViewModelService
    {
        ...
        public virtual CustomerTagProductModel.AddProductModel PrepareProductModel(string customerTagId)
        {
        ...
        public virtual (IList<ProductModel> products, int totalCount) PrepareProductModel(CustomerTagProductModel.AddProductModel model, int pageIndex, int pageSize)
        {
