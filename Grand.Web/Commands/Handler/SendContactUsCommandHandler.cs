...
{
    public class SendContactUsCommandHandler : IRequestHandler<ContactUsCommandModel, ContactUsModel>
    {
        ...
        public SendContactUsCommandHandler(IContactAttributeService contactAttributeService, CommonSettings commonSettings, CaptchaSettings captchaSettings)
        {
