...
namespace Grand.Web.Services
{
    public partial class ShoppingCartWebService: IShoppingCartWebService
    {
        ...
        public ShoppingCartWebService(HttpContextBase httpContext,
        ...
        public virtual void ParseAndSaveCheckoutAttributes(List<ShoppingCartItem> cart, FormCollection form)
        {
            if (cart == null)
                throw new ArgumentNullException("cart");
        ...
        public virtual string ParseProductAttributes(Product product, FormCollection form)
        {
            string attributesXml = "";
        ...
        public virtual void ParseRentalDates(Product product, FormCollection form,
