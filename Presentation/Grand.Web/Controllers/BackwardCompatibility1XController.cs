...
namespace Grand.Web.Controllers
{
    public partial class BackwardCompatibility1XController : BasePublicController
    {
        ...
        public ActionResult RedirectProduct(string id, bool idIncludesSename = true)
        {
            ...
            var productId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var categoryid = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var manufacturerId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var tagId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var newsId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var blogPostId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var topicid = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var forumGroupId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var forumId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
        ...
        {
            //we can't use dash in MVC
            var forumTopicId = idIncludesSename ? id.Split(new [] { '-' })[0] : id;
