    ...
    public class CommonHelperTests {
        ...
        public void SetPropertyTest() {
            ...
            try {
                ...
                Assert.AreEqual("No property 'tempProperty' found on the instance of type 'Nop.Core.Tests.CommonHelperTests+tempClass'.", ex.Message);
            }
        }
        ...
        public void GetNopCustomTypeConverterTest()
        {
            ...
            Assert.AreEqual(
                new Nop.Core.ComponentModel.GenericListTypeConverter<int>().GetType(),
