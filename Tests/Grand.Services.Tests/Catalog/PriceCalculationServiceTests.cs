...
namespace Grand.Services.Catalog.Tests {
    ...
    public class PriceCalculationServiceTests {
        ...
        private Mock<IDiscountService> tempDiscountServiceMock;     //Mock<> IDiscountService for UnitTest method
        private IDiscountService _discountService;                  //object IDiscountService for PriceCalculationService() constructor
        ...
        public void TestInitialize() {
            ...
            tempDiscountServiceMock = new Mock<IDiscountService>();     //Mock<> IDiscountService
            {
                _discountService = tempDiscountServiceMock.Object;      //object IDiscountService
            }
