...
namespace Nop.Services.Directory.Tests {
    [TestClass()]
    public class MeasureServiceTests {
        ...
        public void TestInitialize() {
            /*
                metric units
                Ratio (in decimal) means that EVERYTHING is compared to inches
                e.g.
                0.0254 meter equals to 1 inch
                and so forth
            */
            ...
            /*
                weight units
                Ratio (in decimal) means that EVERYTHING is compared to pounds
                e.g.
                0.45359237 kg equals to 1 pound
                and so forth
            */
